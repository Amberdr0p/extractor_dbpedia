...
public enum DBpediaEnum {
  ...
  LOCATION_DBO("<http://dbpedia.org/ontology/Location>", "http://nerd.eurecom.fr/ontology#Location"), // 130к
  ORGANISATION_DBO("<http://dbpedia.org/ontology/Organisation>", "http://nerd.eurecom.fr/ontology#Organisation"), // 28к
